...
public class SoundManager : MonoBehaviour
{
	...
	[SerializeField] private AudioClip landingSuccessPickupAudioClip;
    ...
    private void Lander_OnLanded(object sender, Lander.OnLandedEventArgs e)
    {
        switch(e.landingType)
        {
            case Lander.LandingType.Success:
				AudioSource.PlayClipAtPoint(landingSuccessPickupAudioClip, Camera.main.transform.position, GetSoundVolumeNormalized());
                break;
            default:
