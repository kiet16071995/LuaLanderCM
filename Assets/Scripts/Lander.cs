...
public class Lander : MonoBehaviour
{
	...
	private void OnCollisionEnter2D(Collision2D collision)
	{
		...
		float relativeLandingVelocityMagnitude = collision.relativeVelocity.magnitude;
		if (relativeLandingVelocityMagnitude > softLandingVelocityMagnitude)
		{
			...
			OnLanded?.Invoke(this, new OnLandedEventArgs
			{
				...
				dotVector = 0f,
				landingSpeed = relativeLandingVelocityMagnitude,
				scoreMultiplier = 0,
				score = 0,
			});
			SetState(State.GameOver);
		...
		float landingSpeedScore = (softLandingVelocityMagnitude - relativeLandingVelocityMagnitude) * maxScoreAmountLandingSpeed;
